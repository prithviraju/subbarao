...
if __name__ == "__main__":
    ...
    Hello, my name is Prithvi Raju and I live in Bhimavaram.
    My credit card number is 4095-2609-9393-4932 and my crypto wallet id is 16Yeky6GMjeNkAiNcBY7ZhrLoMSgg1BoyZ.
    
    On October 6th I visited prithviraju.com and sent an email to test@prithviraju.com,  from the IP 192.168.0.1.
    
    My passport: 191280342 and my phone number: +91 9036063393.
    
    This is a valid International Bank Account Number: IL150120690000003111111 . Can you please check the status on bank account 954567876544?
    
    Kate's social AAdhar number is 3654-4334-1232.  Her driver license? it is 1234567A.
    """
